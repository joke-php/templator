...
см. [01-installation.md](01-installation.md).
...
- [03-syntax-basics.md](03-syntax-basics.md) — полный синтаксис `{{ }}` и `{% %}`, точечная нотация, различие компиляции
  и интерпретации директив.
- [07-joke-integration.md](07-joke-integration.md) — подробнее о DI-резолвинге, жизненном цикле `TemplatedResponse` и
  особенностях middleware (Session/CSRF) для группы маршрутов `web`.
